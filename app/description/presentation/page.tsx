      ...
      <article className="mt-3">
        <figcaption>
          <div className="flex items-center mt-2">
            ...
            <p className="text-2xl ml-2">Exceptionel</p>
          </div>
        ...
        <figcaption>
          ...
          where they can dine at restaurants and snorkel in the house
          reef.Surrounded by a coral reef in Maldives, Dhawa Ihuru - By Banyan
          Tree enjoy beachfront villas with private timber patios on Ihuru
          Island. It offers guided snorkelling safaris, Maldivian cooking
          classes and a PADI dive centre. The thatched-roof villas at the resort
          offer in-room WiFi and feature dining and seating areas in their
          private gardens. It features views of the ocean and toiletries. Some
          villas have an open-air jet pool. Each villa features Maldivian
          swings. Dhawa Ihuru - By Banyan Tree is situated in the North Malé
          Atoll, a 20-minute speedboat ride from Malé International Airport. The
          resort organises island hopping trips and island exploration
          excursions. The property offers massages and aromatherapies at the spa
          or a walk on the white sandy beach. It's water-sports center is well
          equipped, and all non-motorized sports equipment rental is free. The
          property offers Maldivian specialities prepared by the resort's chefs
          on a private sandbank or a barbecue party in your villa. The
          restaurant have an Indian Ocean view with Asian, Mediterranean and
          local dishes, while the waterfront Velaavani serves cocktails. For
          additional dining / activity variety, guests are able to travel to
          Banyan Tree Vabbinfaru, 5 minutes away by speedboat, where they can
          dine at restaurants and snorkel in the house reef.`}
          </p>
        </figcaption>
