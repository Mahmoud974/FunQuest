              ...
              <li className="flex mt-4 flex-col">
                ...
                <ul className="grid grid-cols-2 gap-4 max-w-lg mt-3">
                  {typesHebergement.map((type) => (
                    <li
                      key={type}
                      className="flex text-md items-center justify-center text-center  p-2 border rounded-lg hover:bg-blue-700 hover:text-white hover:font-bold cursor-pointer"
                    >
                      {type}
                    </li>
                  ))}
