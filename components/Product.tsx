...
const Product = ({ hotel }: Props) => {
  return (
    <Link href="/hotel/Plaza">
      <article className="mb-6  max-w-screen-lg overflow-hidden shadow md:pr-8 md:rounded-none rounded-xl">
        <figure className="flex flex-col overflow-hidden bg-white sm:flex-row md:h-80 ">
          ...
          <figcaption className="flex w-full flex-col md:my-0 my-40 sm:w-1/2 sm:p-8 lg:w-3/5 md:items-center  text-center">
            <div className="flex ">
              <h2 className="text-xl  font-bold 0 md:text-2xl ">
                {hotel.name}
              </h2>
